customElements.define('books-market',
      ...
      constructor () {
        ...
        function objectProperty (obj) {
          return new Promise(function (resolve, reject) {
            ...
            if (obj.hasAttribute('parent') === true) {
              black['parent'] = obj.getAttribute('parent')
            } else {
              black['parent'] = 'none'
              //console.assert(false, 'требуется свойтсво black[`parent`]')
            }
        ...
        function scriptTemplate (obj) {
          return new Promise(function (resolve, reject) {
            ...
            if (verify === true) {
              ...
              script.src = `./${obj.tagName.toLowerCase()}.js`
